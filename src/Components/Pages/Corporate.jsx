...
const Corporate = () => {
  const services = [
    ...
    },
    {
      ...
      description: "Specialized health services for workplace safety and compliance",
      features: [
  ...
  const benefits = [
    {
      ...
      description: "Regular health checkups lead to early detection and better health outcomes"
    },
    {
    ...
    },
    {
      ...
      description: "Healthy employees are more productive and have fewer sick days"
    },
    {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Comprehensive health solutions designed for businesses to promote employee wellness, 
            ensure workplace safety, and improve organizational productivity.
          </p>
        </div>

        {/* Services */}
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Our Corporate Services</h2>
        ...
        {/* Benefits */}
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Benefits for Your Organization</h2>
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">We discuss your organization's health needs and requirements</p>
            </div>
            <div className="text-center">
              <div className="bg-blue-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-gray-600">We design a tailored health program for your organization</p>
            </div>
            <div className="text-center">
              <div className="bg-blue-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-gray-600">We execute the health program with on-site or off-site services</p>
            </div>
            <div className="text-center">
              <div className="bg-blue-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-gray-600">We provide ongoing support and health monitoring</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-blue-600 rounded-lg p-8 text-center">
          ...
          <p className="text-blue-100 mb-8 text-lg">
            Contact us today to discuss how we can help improve your organization's health and wellness.
          </p>
        ...
        <div className="mt-16 text-center">
          <h3 className="text-2xl font-bold text-gray-900 mb-4">Corporate Inquiries</h3>
          <p className="text-gray-600 mb-4">
            For corporate partnerships and bulk inquiries, please contact our corporate team:
          </p>
